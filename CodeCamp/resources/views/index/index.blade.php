...
<div id="carouselExampleFade" class="relative h-[500px] lg:h-[800px]! overflow-hidden bg-gray-900">
    ...
    <div class="relative z-20 flex items-center justify-center h-full px-4">
        <div class="max-w-2xl bg-black/30 backdrop-blur-xs py-10 px-8 text-center rounded-2xl border border-white/10" data-aos="fade-up">
            ...
            <button id="startNowBtn" class="inline-block border-2 border-orange-400 bg-orange-400/30 hover:bg-orange-400 text-orange-50 hover:text-white font-bold py-2 px-10 rounded-xl! transition-all duration-300 hover:-translate-y-1 hover:shadow-xl hover:shadow-orange-400/40 text-sm md:text-base lg:text-lg">
                Start Now
            </button>
        </div>
    </div>
